...
targetChannelList = [IED_COUNTER,IED_AF3,IED_GYROSCOPEZ,IED_GYROSCOPEX,IED_GYROSCOPEY,IED_T7,IED_ACCX,IED_Pz,IED_ACCY,IED_ACCZ,IED_T8,IED_MAGY,IED_MAGZ,IED_MAGX,IED_AF4, IED_GYROX, IED_GYROY,IED_TIMESTAMP, IED_FUNC_ID, IED_FUNC_VALUE, IED_MARKER,IED_SYNC_SIGNAL]
header = ['COUNTER','AF3','GYROSCOPEZ','GYROSCOPEX','GYROSCOPEY','T7','ACCX','Pz','ACCY','ACCZ','T8','MAGY','MAGZ','MAGX','AF4', 'GYROX', 'GYROY', 'TIMESTAMP','FUNC_ID', 'FUNC_VALUE', 'MARKER', 'SYNC_SIGNAL']
